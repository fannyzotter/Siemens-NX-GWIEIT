...
public class ShowCAMOperations
{
    ...
    public ShowCAMOperations()
    {
        try
        {
            ...
            theUI = UI.GetUI();
            theDlxFileName = "ShowCAMOperations.dlx";
    ...
    {
        CAM.CAMSession camSession = theSession.CAMSession;
        CAM.CAMSetup setup = camSession.Setup;

        if (setup != null)
        {
            CAM.CAMOperation[] operations = setup.CAMOperationCollection.ToArray();
            string[] opNames = new string[operations.Length];

            for (int i = 0; i < operations.Length; i++)
            {
                opNames[i] = operations[i].Name;
            }

            list_box0.SetListItems(opNames);
        }
        else
        {
            list_box0.SetListItems(new string[] { "Kein CAM Setup gefunden." });
        }
